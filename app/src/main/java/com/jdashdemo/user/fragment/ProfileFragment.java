...
import com.jdashdemo.user.BuildConfig;
import com.jdashdemo.user.R;
import com.jdashdemo.user.activity.ChangepassActivity;
import com.jdashdemo.user.activity.EditProfileActivity;
import com.jdashdemo.user.activity.IntroActivity;
import com.jdashdemo.user.activity.PrivacyActivity;
...
public class ProfileFragment extends Fragment {
    ...
    public View onCreateView(final LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        LinearLayout cs = getView.findViewById(R.id.llcustomerService);
